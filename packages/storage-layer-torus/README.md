...
declare type TorusStorageLayerArgs = {
  ...
  hostUrl?: string; // use `https://metadata.web3auth.io` for connecting to the Torus Metadata Server
...
const storageLayer = new TorusStorageLayer({ hostUrl: "https://metadata.web3auth.io" });
```
